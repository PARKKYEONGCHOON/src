...
#include "yh_sum/yh_sum_msg.h" //msg After build Auto Create



int main(int argc, char **argv)
{
    ros::init(argc,argv, "yh_sum_pub"); // node name init
    ...
    ros::Publisher my_pub = nh.advertise<yh_sum::yh_sum_msg>("yh_sum_topic", 100);
