...
#include "yh_tutorial_2/yh_msg_2.h" //msg After build Auto Create



int main(int argc, char **argv)
{
    ros::init(argc,argv, "yh_pub_2"); // node name init
    ...
    ros::Publisher my_pub = nh.advertise<yh_tutorial_2::yh_msg_2>("yh_topic_2", 100);
